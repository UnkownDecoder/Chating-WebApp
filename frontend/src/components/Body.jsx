    ...
    <div className="flex-grow bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white py-24 px-6 relative overflow-hidden flex items-center justify-center min-h-screen">
      <div className="max-w-7xl mx-auto flex w-full">
        ...
        <div className="w-1/2 text-left">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold glow-effect mb-6 transform transition-all duration-500 ease-in-out hover:scale-105" style={{ fontFamily: 'MonstrousFish' }}>
            Connect with People Like Never Before
          </h1>
          <p className="text-sm md:text-lg lg:text-2xl mb-8 opacity-80 transform transition-all duration-300 ease-in-out hover:scale-105 hover:opacity-100" style={{ fontFamily: 'RacingSportDisplay-Regular' }}>
          ...
          <button
            ...
            style={{ fontFamily: 'RacingSportDisplay-Regular' }}
          >
            Start Chatting Now
          </button>
        </div>
