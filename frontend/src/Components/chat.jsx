...
import ChatHeader from './ChatHeader'; // 👈 ChatHeader import kiya
import { useChatStore } from "../store/useChatStore"; // 👈 Zustand store import kiya
...
const Chat = () => {
  ...
  // 👇 Zustand store se selectedUser aur setSelectedUser fetch kiya
  ...
  const handleFriendSelect = (friendId, friendName) => {
    ...
    // 👇 Zustand store mein selectedUser ko update kiya
  ...
  return (
    <div className="flex h-screen bg-black">
      ...
      <div className="flex-grow flex flex-col bg-gray-900 text-white border-l-2 border-r-2 border-gray-700">
        ...
        {/* Typing indicator aur message input area */}
